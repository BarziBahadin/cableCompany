...
<body>
        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="newAccount.html">New Account</a>
                    </li>
    ...
    <h3 style="color: red;" class="h3 text-center">this account has been ARCHIVED</h3>
    <?php
    ...
    $sql = "SELECT * FROM `customersarchive` WHERE id =" . $id;
    ...
    <div class="container-fluid" style="margin:0  ;">
        ...
        <div class="row">
            ...
            <h4><i class=""></i>Formal Name:
                <form class="form col-sm-2" action="dbm.php?id=<?php echo $id ?>&case=19" method="POST">
        ...
        <div class="row">
            <div class="col-sm-3 h4 ">
                ...
                <ul class="list-group shadow">
                    <li class="list-group-item text-strong"><h4>Created on : <?php echo $date[0] ?> </h4></li>
                    <li class="list-group-item text-strong"><h4>Archived on : <?php echo $date1[0] ?> </h4></li>
                ...
                <form class="form" action="dbm.php" method="POST" id="updateform">
                    <div class="form-group ">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="case" aria-label="Sell Price" value="20" require>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="phone" maxlength="11" id="phone" value="<?php echo $row[4]; ?>" title="enter your phone number if any.">
                        </div>
                    </div>
...
tab
 -->
                ...
                <form class="form" action="dbm.php?cId=<?php echo  $id; ?>" method="POST" id="updateform">
                    ...
                    <div class="form-group ">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" id="first_name" title="cable name" require>
                        </div>
                        <div class="col-md-6">
                            <label for="last_name">
                                <h4>Meter/dana</h4>
    ...
    <script>
        var hatuMonth = document.querySelectorAll(".month-hatu");
        var roishtuMonth = document.querySelectorAll(".month-roishtu");
        let remainingStack = [];
        var id = document.getElementById("custumer_ID").innerHTML;
     
        for (let index = 0; index < roishtuMonth.length; index++) {
            console.log('roishtu - hatu in month :' + (roishtuMonth[index].innerHTML - hatuMonth[index].innerHTML));
            pushToStack((roishtuMonth[index].innerHTML - hatuMonth[index].innerHTML))
        }

        function pushToStack(remaining) {
            remainingStack.push(remaining);
        }
        console.log(remainingStack)
    </script>
    <form id="form" action="dbm.php?case=18" method="POST">
        <input type="hidden" name="sql" id="in" aria-label="Sell Price">
    </form>

    <?php
    $nextMonth = date('m') + 1;
    $startMonth = "1-" . $nextMonth;
    $date = date('d-m');
 
    if ($startMonth == $date) {
    ?>
    <script>   console.log(remainingStack);
        var rmain = remainingStack.pop();
            if(rmain >0){
            var sql = "INSERT INTO `accountsell` (`customer_Id`, `cableName`, `meter`, `pricePerMeter`, `total`) VALUES (" +id+ ", 'ramming many of previous month ', 0,0," +rmain+ ")";
            document.getElementById('in').value = sql;
            document.getElementById("form").submit();
        } else{
            var sql = "INSERT INTO `accountsell1` (`customer_Id`, `cableName`, `meter`, `pricePerMeter`, `total`) VALUES (" +id+ ", 'ramming many of previous month ', 0,0," +rmain+ ")";
            document.getElementById('in').value = sql;
            document.getElementById("form").submit();
